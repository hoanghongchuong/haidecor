...
class IndexController extends Controller {
	...
	*/
	...
	public function index()
	{
		...
		$news = DB::table('news')->where('status',1)->where('com','tin-tuc')->take(20)->orderBy('id','desc')->get();
		$products = DB::table('products')->where('status',1)->where('com','san-pham')->take(20)->orderBy('id','desc')->get();
		$categories_home = ProductCate::where('status',1)->where('com','san-pham')->where('noibat',1)->take(3)->orderBy('id','desc')->get();
		$setting =DB::table('setting')->select()->where('id',1)->get()->first();
